...
def draw_board():
	for c in range(COLUMNS):
		for r in range(ROWS):
			if board[r][c]==1:
				window.fill(CIRCLE,((c*200)+50,(c*200)+50))
				if board[r][c]==2:
					window.fill(CROSS,((c*200)+50,(c*200)+50))
...
def is_winning_move(player):
	...
	if board[0][0] == player and board[1][1]== player and board[2][2]== player:
			...
			return True
	if board[2][0] == player and board[1][c]== player and board[0][2]== player:
			pygame.draw.line(window, winning_color,(590, 10), (0, 590),10)
			return True
